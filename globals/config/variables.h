...
namespace n_variables
{
	struct impl_t {
		...
		ADD_VARIABLE( int, m_routecalc_max_ticks, 256 );
		ADD_VARIABLE( int, m_routecalc_max_sequences, 5000 );
		ADD_VARIABLE( int, m_routecalc_max_variants, 60000 );
		ADD_VARIABLE( int, m_routecalc_hard_timeout_ms, 4500 );
		ADD_VARIABLE( float, m_routecalc_max_render_distance, 1000.f );
		ADD_VARIABLE( float, m_routecalc_point_radius_floor, 18.f );
		ADD_VARIABLE( float, m_routecalc_point_radius_pixelsurf, 8.f );
