...
namespace n_variables
{
	struct impl_t {
		...
		ADD_VARIABLE( bool, m_debug_log_particle_cooldowns, false );
		...
		ADD_VARIABLE( bool, m_particles_working_only, true );
		ADD_VARIABLE( bool, m_particles_show_experimental, false );
		ADD_VARIABLE( bool, m_particle_fallback_enabled, true );
		ADD_VARIABLE( int, m_particle_fallback_mode, 2 );
