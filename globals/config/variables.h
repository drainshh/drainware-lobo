...
namespace n_variables
{
	struct impl_t {
		...
		ADD_VARIABLE( bool, m_burmalda_mode, false );
		ADD_VARIABLE( int, m_burmalda_x, 34 );
		ADD_VARIABLE( int, m_burmalda_y, 84 );
		ADD_VARIABLE( int, m_burmalda_style, 0 );
		ADD_VARIABLE( float, m_burmalda_intensity, 0.65f );
		ADD_VARIABLE( bool, m_burmalda_use_accent, true );
		ADD_VARIABLE( c_color, m_burmalda_color, c_color( 255, 170, 70, 235 ) );
		...
		ADD_VARIABLE( bool, m_routecalc_render_result, true );
		...
		ADD_VARIABLE( bool, m_routecalc_show_all_debug_candidates, false );
		ADD_VARIABLE( bool, m_routecalc_bruteforce_enabled, true );
		ADD_VARIABLE( bool, m_routecalc_start_from_current_player, true );
		ADD_VARIABLE( bool, m_routecalc_use_all_points, true );
		ADD_VARIABLE( bool, m_routecalc_use_hull_trace, true );
		ADD_VARIABLE( bool, m_routecalc_show_rejects, false );
		ADD_VARIABLE( bool, m_routecalc_allow_heavy_cpu, true );
		ADD_VARIABLE( int, m_routecalc_max_displayed_combos, 4 );
		ADD_VARIABLE( int, m_routecalc_preset, 1 );
		ADD_VARIABLE( int, m_routecalc_pixelsurf_validation_mode, 0 );
		ADD_VARIABLE( int, m_routecalc_tickrate, 64 );
		ADD_VARIABLE( int, m_routecalc_max_depth, 4 );
		ADD_VARIABLE( int, m_routecalc_max_ticks, 384 );
		ADD_VARIABLE( int, m_routecalc_max_sequences, 7500 );
		ADD_VARIABLE( int, m_routecalc_max_variants, 90000 );
		ADD_VARIABLE( int, m_routecalc_hard_timeout_ms, 8000 );
		ADD_VARIABLE( int, m_routecalc_log_top_candidates, 10 );
		ADD_VARIABLE( bool, m_routecalc_log_all_candidate_summaries, false );
		ADD_VARIABLE( float, m_routecalc_max_render_distance, 1000.f );
		ADD_VARIABLE( float, m_routecalc_point_radius_floor, 24.f );
		ADD_VARIABLE( float, m_routecalc_point_radius_pixelsurf, 10.f );
		ADD_VARIABLE( c_color, m_routecalc_point_color, c_color( 75, 185, 255, 245 ) );
		ADD_VARIABLE( c_color, m_routecalc_result_color, c_color( 255, 95, 210, 245 ) );
		ADD_VARIABLE( std::string, m_routecalc_manual_combo, "" );
