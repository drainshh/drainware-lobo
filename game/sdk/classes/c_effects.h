...
public:
	...
	virtual void sparks( const c_vector& position, int magnitude = 1, int trail_length = 1, const c_vector* direction = nullptr ) = 0;
	virtual void dust( const c_vector& position, const c_vector& direction, float size, float speed ) = 0;
};
