...
bool n_hooks::impl_t::on_attach( )
{
	...
	initialise_hook( m_get_color_modulation, g_modules[ MATERIALSYSTEM_DLL ].find_pattern( "55 8B EC 83 EC ? 56 8B F1 8A 46" ),
	                 &n_detoured_functions::get_color_modulation, "IMaterial::GetColorModulation()" );
